...
# Loading model
model = cv2.dnn.readNetFromTensorflow('models/graph.pb',
...
def detection(file):
    ...
    model.setInput(cv2.dnn.blobFromImage(frame, swapRB=True))
